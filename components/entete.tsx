...
export default function Entete({props}: {props:{projets: any[], outil: any[], outils: any[], etat: any[], users: any[]}}) {
    
    const { projets, outil, outils, etat, users } = props;
    ...
    return (
		<Card className="bg-gradient-to-r from-blue-500 to-purple-500 text-white p-4 rounded-lg mb-4 flex flex-row shadow-sl gap-10">
			...
			<div className="bg-gray-100 text-gray-900 p-4 rounded-lg pl-10 pr-10 min-w-auto shadow-xl flex-none">
				<pre>Données :<br/>
